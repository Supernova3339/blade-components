    ...
    <header class="z-50 sticky top-0 flex items-center shadow-sm bg-white h-16 py-2" role="banner">
        <div class="container flex items-center max-w-6xl mx-auto px-4 lg:px-4">
            ...
            <div class="hidden lg:flex items-center justify-end">
                <a href="https://github.com/supernova3339" target="_blank" rel="noopener" class="no-underline flex mr-4 text-gray-600 pl-8">
                ...
                <a href="https://twitter.com/supernova3339" target="_blank" rel="noopener" title="Follow me on twitter" class="no-underline text-gray-600">
        ...
        <footer class="bg-white text-center text-sm mt-12 py-4" role="contentinfo">
            <ul class="flex flex-col md:flex-row justify-center">
                <li class="md:mr-2">
                    Created by <a href="https://superdev.one" title="SuperDev">Supernova3339</a>
                </li>
